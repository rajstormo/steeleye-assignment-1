...
const Dashboard = () => {
  ...
  const showSelectedOrders = (index) => {
  ...
  return (
    <div>
      ...
      <div className={styles.content}>
        ...
        <List rows={mockData.results} timeStamp={timestamps.results} onSelect={showSelectedOrders} searchedText={searchText} currency={currency}/>
      </div>  
    </div>
  );
};
